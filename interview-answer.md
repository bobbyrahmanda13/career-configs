## List list pertanyaan Interview 
...
- Purcasing staff dan logistik itu Apa
  ...
  - Tugas Utama dari logistik
    - Penerimaan : barang yang datang dari supllier / vendor harus di check dulu apakah sesuai dengan pesanan atau tidak, jika tidak maka di konfirmasi kembali kepada supplier / vendor nya bahwasannya barang nya tersebut berbeda jadi harus berkoordinasi
    - Penyimpanan (Warehousing) : Mengelola serta mengatur tata letak barang digudang agar mudah ditemukan jika barang tersebut dibutuhkan
    - Distribusi : Mengirim barang / Melakukan packing terhadap barang tersebut lalu mengirim nya ke konsumen / user / departemen yang membeli barang tersebut tapi sebelum itu menginfokan ke user bahwasannya barang tersebut akan dikirimkan
    - Inventaris : Menjaga supaya stock di sistem sama dengan fisik jadi harus melakukan stock opname 
